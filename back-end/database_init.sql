...
CREATE TABLE IF NOT EXISTS B3_FIIS_HISTORICO (
    ID_FIIS_HIST SERIAL PRIMARY KEY,
    DAT_INFO DATE NOT NULL DEFAULT CURRENT_DATE,
    TICKER VARCHAR(20) NOT NULL,
    PRECO NUMERIC(20,4) NOT NULL,
    ULTIMO_DIVIDENDO NUMERIC(20,4),
    DIVIDEND_YIELD NUMERIC(20,4),
    VALOR_PATRIMONIAL NUMERIC(20,4),
    PRECO_SOBRE_VALOR_PATRIMONIAL NUMERIC(20,4),
    LIQUIDEZ_MEDIA_DIARIA NUMERIC(20,4),
    PERC_EM_CAIXA NUMERIC(20,4),
    CAGR_DIVIDENDOS NUMERIC(20,4),
    CAGR_COTA NUMERIC(20,4),
    PATRIMONIO NUMERIC(20,4),
    NUM_COTISTAS NUMERIC(20,4),
    GESTAO VARCHAR(20),
    COTAS NUMERIC(20,4)
);

CREATE INDEX IDX_B3_FIIS_HISTORICO_BY_TICKER ON B3_FIIS_HISTORICO (TICKER);

CREATE INDEX IDX_B3_FIIS_HISTORICO_BY_DAT ON B3_FIIS_HISTORICO (DAT_INFO);


CREATE TABLE IF NOT EXISTS STOCKS_HIST (
    ID_STOCKS_HIST SERIAL PRIMARY KEY,
    DAT_INFO DATE NOT NULL DEFAULT CURRENT_DATE,
    TICKER VARCHAR(20) NOT NULL,
    PRECO NUMERIC(20,4) NOT NULL,
    DIVIDEND_YIELD NUMERIC(20,4),
...
CREATE INDEX IDX_STOCKS_HIST_BY_TICKER ON STOCKS_HIST (TICKER);

CREATE INDEX IDX_STOCKS_HIST_BY_DAT ON STOCKS_HIST (DAT_INFO);

CREATE TABLE IF NOT EXISTS REITS_HIST (
    ID_REITS_HIST SERIAL PRIMARY KEY,
    DAT_INFO DATE NOT NULL DEFAULT CURRENT_DATE,
    TICKER VARCHAR(20) NOT NULL,
    PRECO NUMERIC(20,4) NOT NULL,
    DIVIDEND_YIELD NUMERIC(20,4),
...
CREATE INDEX IDX_REITS_HIST_BY_TICKER ON REITS_HIST (TICKER);

CREATE INDEX IDX_REITS_HIST_BY_DAT ON REITS_HIST (DAT_INFO);